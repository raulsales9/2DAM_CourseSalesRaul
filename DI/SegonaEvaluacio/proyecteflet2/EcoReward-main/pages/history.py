...
class History(ft.UserControl):
    ...
    def build(self):
        self.title = ft.Container(ft.Text("History"), alignment=ft.alignment.center)
        rows = []
        for product in self.products:
            ...
            buy_price_row = ft.Row([ft.Container(ft.Text(product["price"], size=18), width=50, height=30)])
        ...
        self.content = ft.Container(ft.Column(rows, scroll="always", width=400,height=100), width=400, height=630) 
