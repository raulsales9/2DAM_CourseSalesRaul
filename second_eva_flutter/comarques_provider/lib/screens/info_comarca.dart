...
import 'package:comarques_provider/screens/info_comarca_detall.dart';
...
class _InfoComarcaState extends State<InfoComarca> {
  ...
  Widget build(BuildContext context) {
    var providerComarques = Provider.of<ComarquesProvider>(context);
    providerComarques.nomComarcaActual = widget.nomcomarca;
