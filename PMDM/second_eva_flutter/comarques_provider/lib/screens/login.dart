import 'package:comarques_provider/screens/registerForm.dart';
import 'package:comarques_provider/screens/selector_provincia.dart';
      ...
      body: Container(
        ...
        child: Center(
          child: Column(
            ...
            children: [
              Image.asset("assets/img/logo.png", height: 400, width: 400,),
              Text(
